...
public class StoneMaterial {
    ...
    public StoneMaterial(String name, AbstractBlock.Settings settings, ItemGroup itemGroup, Kinds[] blacklist) {
        ...
        if (!list.contains(Kinds.Bricks)) {
            ...
            Blocks.register(name + "_bricks_slab", new SlabBlock(FabricBlockSettings.copy(BRICKS.getLeft())), itemGroup);
            ...
            Blocks.register(name + "_bricks_wall", new WallBlock(FabricBlockSettings.copy(BRICKS.getLeft())), itemGroup);
        }
        ...
        if (!list.contains(Kinds.MossyBricks)) {
            ...
            Blocks.register(name + "_mossy_bricks_slab", new SlabBlock(FabricBlockSettings.copy(MOSSY_BRICKS.getLeft())), itemGroup);
            ...
            Blocks.register(name + "_mossy_bricks_wall", new WallBlock(FabricBlockSettings.copy(MOSSY_BRICKS.getLeft())), itemGroup);
        }
        ...
        if (!list.contains(Kinds.CrackedBricks)) {
            ...
            Blocks.register(name + "_cracked_bricks_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_BRICKS.getLeft())), itemGroup);
            ...
            Blocks.register(name + "_cracked_bricks_wall", new WallBlock(FabricBlockSettings.copy(CRACKED_BRICKS.getLeft())), itemGroup);
        }
