...
public class StoneMaterial {
    ...
    public StoneMaterial(String name, AbstractBlock.Settings settings, ItemGroup itemGroup, Kinds[] blacklist) {
        ...
        if (!list.contains(Kinds.Base)) {
            ...
            Blocks.register(name + "_slab", new SlabBlock(FabricBlockSettings.copy(BASE.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Smooth)) {
            ...
            Blocks.register("smooth_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(SMOOTH.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Cut)) {
            ...
            Blocks.register("cut_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(CUT.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.CrackedCut)) {
            ...
            Blocks.register("cracked_cut_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_CUT.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Polished)) {
            ...
            Blocks.register("polished_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(POLISHED.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.CrackedPolished)) {
            ...
            Blocks.register("cracked_polished_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_POLISHED.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Cobbled)) {
            ...
            Blocks.register("cobbled_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(COBBLED.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.MossyCobbled)) {
            ...
            Blocks.register("mossy_cobbled_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(MOSSY_COBBLED.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Shingles)) {
            ...
            Blocks.register(name + "_shingle_slab", new SlabBlock(FabricBlockSettings.copy(BRICKS.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.MossyShingles)) {
            ...
            Blocks.register(name + "_mossy_shingle_slab", new SlabBlock(FabricBlockSettings.copy(MOSSY_BRICKS.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.CrackedShingles)) {
            ...
            Blocks.register(name + "_cracked_shingle_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_BRICKS.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Bricks)) {
            ...
            Blocks.register(name + "_brick_slab", new SlabBlock(FabricBlockSettings.copy(BRICKS.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.MossyBricks)) {
            ...
            Blocks.register(name + "_mossy_brick_slab", new SlabBlock(FabricBlockSettings.copy(MOSSY_BRICKS.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.CrackedBricks)) {
            ...
            Blocks.register(name + "_cracked_brick_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_BRICKS.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Briquettes)) {
            ...
            Blocks.register(name + "_briquettes_slab", new SlabBlock(FabricBlockSettings.copy(BRIQUETTES.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.MossyBriquette)) {
            ...
            Blocks.register(name + "_mossy_briquettes_slab", new SlabBlock(FabricBlockSettings.copy(MOSSY_BRIQUETTES.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.CrackedBriquette)) {
            ...
            Blocks.register(name + "_cracked_briquettes_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_BRIQUETTES.getLeft())), itemGroup);
        ...
        if (!list.contains(Kinds.Packed)) {
            Pair<Block, Item> CRACKED_BRIQUETTES = Blocks.register("packed_" + name, new Block(settings), itemGroup);
            Blocks.register("packed_" + name + "_slab", new SlabBlock(FabricBlockSettings.copy(CRACKED_BRIQUETTES.getLeft())), itemGroup);
            Blocks.register("packed_" + name + "_stairs", new StairsBlock(CRACKED_BRIQUETTES.getLeft().getDefaultState(), FabricBlockSettings.copy(CRACKED_BRIQUETTES.getLeft())), itemGroup);
            Blocks.register("packed_" + name + "_wall", new WallBlock(FabricBlockSettings.copy(CRACKED_BRIQUETTES.getLeft())), itemGroup);
        }
