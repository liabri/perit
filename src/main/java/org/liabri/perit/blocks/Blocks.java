...
public class Blocks {
    ...
    public static final Pair<Block, Item> BLUE_NETHER_BRICK_SLAB = register("blue_nether_brick_slab", new SlabBlock(FabricBlockSettings.copyOf(BLUE_NETHER_BRICKS.getLeft())), ItemGroup.BUILDING_BLOCKS);
